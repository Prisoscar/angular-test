...
export class ElementiListaResolver implements Resolve<Observable<ElementoLista []>>{
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<ElementoLista[]>{
        ...
        console.log("ElementiListraResolver => Retrieving list elements: " + this.urlLista + "?idLista=" + idLista);
